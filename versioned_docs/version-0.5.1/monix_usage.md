...
### SBT
```scala
libraryDependencies +=  "com.disneystreaming" %% "weaver-monix" % "0.5.0+30-12832a4d" % Test
```
...
object test extends Tests {
  def ivyDeps = Agg(
    ivy"com.disneystreaming::weaver-monix:0.5.0+30-12832a4d"
  )
}
```
