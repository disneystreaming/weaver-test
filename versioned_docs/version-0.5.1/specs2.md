...
### SBT
```scala
libraryDependencies +=  "com.disneystreaming" %% "weaver-specs2" % "0.5.0+30-12832a4d" % Test
```
...
object test extends Tests {
  def ivyDeps = Agg(
    ivy"com.disneystreaming::weaver-specs2:0.5.0+30-12832a4d"
  )
}
```
